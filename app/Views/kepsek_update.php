      ...
      <div class="container-fluid">
        <div class="row">
        	<div class="col-lg-12">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form role="form" action="<?= base_url('headmaster/update') ?>" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-6">
                      <?php foreach ($info as $value) { ?>
                    	...
                    	<div class="form-group">
                    		...
                    		<input class="form-control" type="text" name="namakep" value="<?= $value->namakep ?>"readonly="">
                    	</div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                        <div class="col-6">
                        <input class="form-control" name="tmp" value="<?= $value->tmp ?>" required="">
                        </div>
                        <div class="col-6">
                        ...
                        <select name="agama" class="form-control select2" style="width: 100%;">
                  		...
                  		<div class="form-group">
                  			<label>Masukan No HP</label>
                  				<input type="text" name="nohp" class="form-control" value="<?= $value->nohp ?>" required="">
                  		</div>
                  		<div class="form-group">
