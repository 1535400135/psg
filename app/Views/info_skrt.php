          <div class="col-md-12">
            ...
            <div class="card card-widget widget-user-2">
              ...
              <div class="widget-user-header bg-info">
                ...
                <h3 class="widget-user-username">Bendahara Sekolah</h3>
                <h5 class="widget-user-desc"><?= $value->nama_skl ?><a href="<?= base_url('skrt/edit') ?>" class="float-right btn btn-warning">Ubah Data</a></h5>
                <?php } ?>
              </div>
              <div class="card-footer p-0">
                <ul class="nav flex-column">
                  <?php foreach ($info as $value) { ?>
                    ...
                    <b>Nomor Induk Bendahara Sekolah</b><i class="float-right" style="margin-right: 50px"><?= $value->nib ?></i>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" style="margin-left: 40px">
                    <b>Nama Bendahara Sekolah</b><i class="float-right" style="margin-right: 50px"><?= $value->nama_ben ?></i>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" style="margin-left: 40px">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" style="margin-left: 40px">
                      <b>Tempat / Tanggal Lahir</b><i class="float-right" style="margin-right: 50px"><?= $value->tempat ?> / <?= $value->tgl ?></i>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" style="margin-left: 40px">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" style="margin-left: 40px">
                      <b>No Handphone</b><i class="float-right" style="margin-right: 50px"><?= $value->no_hp ?></i>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" style="margin-left: 40px">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" style="margin-left: 40px" href="<?= base_url() .'/sk_bendahara/'.$value->file;?>" target="_blank">
