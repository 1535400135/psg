        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php echo form_open_multipart('su/berita/save'); ?>
                <div class="card-body">
                ...
                <div class="table-responsive">
                  <table id="example1" class="table m-0">
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;"><a href="#" class="fa fa-edit"><small> Edit</small></a> | <a href="#" class="fa fa-trash"><small> Hapus</small></a></td>
                    </tr>
                    <?php } ?>
                    </tbody>
                  </table>
